...
- (void)setupToolbar
{
    ...
    ZSSBarButtonItem *fontItem = [[ZSSBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"ZSSinsertkeyword.png"] style:UIBarButtonItemStylePlain target:self action:@selector(didTapFontButton:)];
